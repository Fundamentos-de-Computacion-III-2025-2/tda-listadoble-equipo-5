        ...
        do {
            try {
                opcion = Integer.parseInt(JOptionPane.showInputDialog(null,
                        ...
                        "Menú de opciones", 3));
                switch (opcion) {
                    case 1: // Insertar un elemento al inicio - ANGEL ANDRES SANTILLANES HERNANDEZ
                        try {
                            ...
                            JOptionPane.showMessageDialog(null, "Error" + n.getMessage(), "No se insertó", 0);
                        }
                        break;
                    case 2:// Insertar un elemento al final - ALAN HORACIO BEJARANO CASTRO
                        try {
                            elemento = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingresa el elemento por insertar al final:", "Insertar al final", 3));
                            lista.insertarFinal(elemento);
                            JOptionPane.showMessageDialog(null, "Elemento " + elemento + " insertado al final.");
                        } catch (NumberFormatException n) {
                            JOptionPane.showMessageDialog(null, "Debe ingresar un valor numérico.", "Error de formato", JOptionPane.ERROR_MESSAGE);
                        }
                        break;
                    case 3: // Insertar un elemento en orden - ELIAS VALDEZ MIRANDA
                        try {
                            elemento = Integer.parseInt(JOptionPane.showInputDialog(null,
                                    "Ingresa el elemento: ",
                                    "Insertar en orden: ", 3));
                        ...
                        break;
                    case 4: // Eliminar un elemento al inicio - ANGEL ANDRES SANTILLANES HERNANDEZ
                        try {
                        ...
                        break;
                    case 5: // Eliminar un elemento al final - ALAN HORACIO BEJARANO CASTRO
                        try {
                        ...
                        break;
                    case 6: // Eliminar un elemento - JOSUE EMILIANO ROBLEDO VILLEGAS
                        try {
                        ...
                        break;
                    case 7: // Buscar un elemento - JOSUE EMILIANO ROBLEDO VILLEGAS
                        try {
                            elemento = Integer.parseInt(JOptionPane.showInputDialog(null,
                    ...
                    case 8: // MostrarLista (InicioFin)
                        ...
                        break;
                    case 9: // MostrarLista (FinInicio) - JOSE EVERARDO HERNANDEZ MONTOYA
